export default function DashboardMetrics({ dashboard, loading = false }) {
  ...
  return (
    <section className="metrics" aria-label="리소스 요약" aria-busy={loading}>
